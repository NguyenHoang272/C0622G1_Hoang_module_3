...
<div>
    <table id="tableFacility" class="table table-dark" style="text-align: center" border="1">
        ...
        <tbody>
        <c:forEach items="${facilityList}" var="facility" varStatus="stt">
        <tr>
            <td>${stt.count}</td>
            ...
            <td>
                ...
                <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delete${facility.serviceID}">
                    Delete
                </button>

                <!-- Modal -->
                <div class="modal fade " id="delete${facility.serviceID}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog ">
                        <div class="modal-content bg-dark">
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="?action=delete&id=${facility.serviceID}" class="btn btn-danger">Delete</a>
                            </div>
                        </div>
                    </div>
                </div>
